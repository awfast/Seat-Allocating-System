...
public class DataReader {
	...
	private String[] cohorts = {"ADMN", "ANTH", "ARCH", "ARTD", "AUDI", "BIOL", "CENV", "CHEM", "CHIN", "CHIN", "COMP", "CRIM", "CZEC", "DUTC", "ECON", "ECSG", "EDUC", "ELEC", "ENTR", "FEEG", "FILM", "FREN", "GEOG", "GERM", "GREE", "HIST", "HLTH", "HPRS", "HSQM",
			"HUMA", "IFYP", "IPLU", "ITAL", "JAPA", "LANG", "LATI", "LAWS", "LING", "LLLL", "MANG", "MATH", "MEDI", "MUSI", "NPCG", "NPCH", "NPMH", "NPMS", "NQCG", "NURS", "OCCT", "OPTO", "PAIR", "PHIL", "PHYS", "PODY", "POLS", "PORT", "PRES", "PSIO", "PSYC", "RESM", 
			"RUSS", "SESG", "SESM", "SESS", "SOCI", "SOES", "SPAN", "SAAS", "STAT", "UOSM", "WEBS"};
